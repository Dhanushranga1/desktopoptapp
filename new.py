...
# Display the defect densities of intervals in a tabular manner
print("\nDefect Densities of Intervals:")
for i in range(len(interval_points)):
    print(f"Interval: {interval_points[i]}-{interval_points[i] + interval}, Defect Density: {defect_densities[i]}")