...
# Main function
def main(defects, length, width, threshold_ppms, num_sections, canvas_frame1, canvas_frame2, canvas_frame3, result_text):
    ...
    if original_ppms > threshold_ppms:
        ...
        result_text.insert(tk.END, f"Total Length of cut parts: {total_cut_length+1} meters\n")
        ...
        plot_fabric_sections(canvas_frame3, length, new_length, removed_sections, width)
    else:
...
class FabricOptimizerApp(tk.Tk):
    def __init__(self):
        ...
        self.canvas_frame3 = tk.Frame(self)
        self.canvas_frame3.pack(side=tk.TOP, fill=tk.BOTH, expand=True)
    ...
    def optimize_fabric(self):
        ...
        main(self.defects, length, width, threshold_ppms, num_sections, self.canvas_frame1, self.canvas_frame2, self.canvas_frame3, self.result_text)
