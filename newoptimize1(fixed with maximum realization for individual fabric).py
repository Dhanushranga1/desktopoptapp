...
def maximize_remaining_length(defects, length, width, target_points_per_100_sqm):
    ...
    while points_per_100_sqm > target_points_per_100_sqm and remaining_defects:
        ...
        remaining_length -= (max_defect[1] - max_defect[0] + 1) * (max_defect[2] / total_points)
...
cut_positions_a, points_per_100_sqm_a, remaining_length_a = maximize_remaining_length(fabric_a_defects, fabric_a_length, fabric_width, 23)
cut_positions_b, points_per_100_sqm_b, remaining_length_b = maximize_remaining_length(fabric_b_defects, fabric_b_length, fabric_width, 23)
