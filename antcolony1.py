...
# Calculate the total points for the fabric roll
total_points = sum(roll['points'] for roll in fabric_rolls)

# Calculate the total area of the fabric
total_area = sum(roll['length'] * width for roll in fabric_rolls)

# Calculate the defect point density
defect_point_density = (total_points * 100) / total_area

print(f"Defect point density: {defect_point_density:.2f} points per 100 square meters")